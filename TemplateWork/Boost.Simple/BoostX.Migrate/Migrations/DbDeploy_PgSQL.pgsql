...
CREATE TABLE "BoostSchemaX"."IpInfo" (
    ...
    "LastChangedUtc" timestamp without time zone NOT NULL,
...
VALUES (-1, 'Localhost', '127.0.0.1', TIMESTAMP '1970-01-01T00:00:00', TRUE);
...
VALUES ('20260517161212_InitBoostCTX', '8.0.26');
