...
$migrations = @(
    @{ Name = "InitDbTest"; Context = "DbTest"; OutDir = "Migrations/MsSQL/MgDbTest"; OutFile = "Migrations/MsSQL/InitDbTest.sql" }
)

$filesInOrder = @(
    "Migrations/MsSQL/InitDbTest.sql",
    "SQL/MsSQL.sql"
)
